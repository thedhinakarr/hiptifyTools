...
const addPermissionsToSheet = async (spreadsheetId) => {
  try {
    ...
    const requestBody2 = {
      emailAddress: `dhinakar210902@gmail.com`,
      role: 'writer',
      type: 'user',
    };
    ...
    console.log(`Permissions added for dhinakar210902@gmail.com`);
...
const createSheetAndAddData = async () => {
  try {
    ...
    const requestBody = {
      properties: {
        title: `${date.toLocaleDateString()}_${date.toLocaleTimeString()} showsonsale Data`, // Specify your sheet name here
      },
      sheets: [
        {
          properties: {
